...
in
{
  ...
  swaylockColors = {
    bg = c.sumiInk1; bg2 = c.sumiInk2; fg = c.fujiWhite;
    accent = c.crystalBlue; clear = c.waveAqua; wrong = c.waveRed;
    green = c.springGreen; purple = c.oniViolet; yellow = c.carpYellow; orange = c.roninYellow;
  };
